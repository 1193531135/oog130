...
// 男女
const imgUrl = pageData["ChooserGender"] ? new URL("@/assets/image/taiChiExperienceCheck-1.webp", import.meta.url): new URL("@/assets/image/taiChiExperienceCheck-0.webp", import.meta.url)
